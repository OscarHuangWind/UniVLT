...
def get_args_parser():
    ...
    parser.add_argument('--input_file', type=str, default='LTA_risk_internvl_8b1.json')
...
if __name__ == "__main__":
    ...
    csv_file_path = args.input_file.replace('.json', '.csv')
    ...
    print(f"All JSON files have been converted to CSV files and saved in the new folder: {csv_file_path}")
